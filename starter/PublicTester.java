...
public class PublicTester {
    ...
    /**
     * Test MyHashSet contains with a valid element
     */
    @Test
    public void testMyHashSetContains() {
        boolean success = threeElementSet.contains("A");

        // Assert correct state of hash table
        assertTrue(threeElementSet.hashMap.hashTable[0].equals(threeElementSet.hashMap.new Node<String, Object>("A", MyHashSet.DEFAULT_OBJECT)));
        assertTrue(threeElementSet.hashMap.hashTable[0].getNext().equals(threeElementSet.hashMap.new Node<String, Object>("F",MyHashSet.DEFAULT_OBJECT)));
        assertNull(threeElementSet.hashMap.hashTable[0].getNext().getNext());
        assertTrue(threeElementSet.hashMap.hashTable[1].equals(threeElementSet.hashMap.new Node<String, Object>("B", MyHashSet.DEFAULT_OBJECT)));
        assertNull(threeElementSet.hashMap.hashTable[1].getNext());
        assertNull(threeElementSet.hashMap.hashTable[2]);
        assertNull(threeElementSet.hashMap.hashTable[3]);
        ...
        success = threeElementSet.contains("B");
        ...
        success = threeElementSet.contains("F");
